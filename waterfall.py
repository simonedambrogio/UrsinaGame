...
for i in range(num):
	e1[i] = Entity(model="sphere", color=color.red, scale=0.1, position=(x1[i], y1[i], z1[i]))
	e2[i] = Entity(model="sphere", color=color.yellow, scale=0.1, position=(x2[i], y2[i], z2[i]))
	e3[i] = Entity(model="sphere", color=color.white, scale=0.1, position=(x3[i], y3[i], z3[i]))
	e4[i] = Entity(model="sphere", color=color.cyan, scale=0.1, position=(x4[i], y4[i], z4[i]))
	e5[i] = Entity(model="sphere", color=color.green, scale=0.1, position=(x5[i], y5[i], z5[i]))
